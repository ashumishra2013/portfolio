...
const FullProjectModal = (props: any) => {
    ...
    return <Modal.Root scrollAreaComponent={ScrollArea.Autosize} size="lg" centered className=" font-mono" opened={props.opened} onClose={props.close}>
        ...
        <Modal.Content className="!rounded-3xl">
            ...
            <Modal.Body className="!bg-bgColor xs-mx:!p-2 !pt-2 !border-primaryColor  !border-2 !border-t-0 !rounded-bl-3xl !rounded-br-3xl">
                ...
                <Group justify="space-between" mt="md" mb={3} >
                    ...
                    <a href={props.link} target="_blank" className="!w-[48%] "></a>
                </Group>
            </Modal.Body>
        </Modal.Content>
    </Modal.Root>
